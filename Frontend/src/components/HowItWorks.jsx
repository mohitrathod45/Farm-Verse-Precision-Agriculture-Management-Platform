...
const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      step: 'Step 4',
      title: 'Schedule & Log',
      description: 'Record irrigation schedules, fertilizer usage, and check real-time weather forecasts.',
      icon: RiDropLine,
    ...
    },
    {
      step: 'Step 5',
      title: 'AI & Reports',
      description: 'Get instant AI-powered farming advice and generate farm observation reports.',
