  ...
  const points = [
    {
      ...
      description: 'Organize and oversee all your farm properties and information from one unified account.',
      icon: RiMap2Line,
      color: 'text-primary border-primary/20 bg-primary/5',
    },
    {
      title: 'Crop Management',
      description: 'Track crops across your farms, crop types, sowing dates, and growth stages.',
      icon: RiPlantLine,
      color: 'text-secondary border-secondary/20 bg-secondary/5',
    },
    {
      title: 'Irrigation Management',
      description: 'Schedule and manage watering activities by farm to optimize field hydration.',
      icon: RiDropLine,
      color: 'text-sky-500 border-sky-500/20 bg-sky-500/5',
    },
    {
      title: 'Fertilizer Tracking',
      description: 'Record fertilizer applications, product usage, and historical application records.',
      icon: RiFlaskLine,
      color: 'text-orange-500 border-orange-500/20 bg-orange-500/5',
    },
    {
      title: 'Reports & Observations',
      description: 'Create and manage farm reports to document observation records and field activities.',
      icon: RiBarChart2Line,
      color: 'text-accent border-accent/20 bg-accent/5',
    },
    {
      title: 'Secure Platform',
      description: 'Protect farm records with JWT authentication and secure role-based profile access.',
